  ...
  return (
    <main className="min-h-screen bg-[#f7f8fa] text-[#15232f]">
      <div className="flex min-h-screen">
        <aside className={`fixed inset-y-0 left-0 z-40 flex w-[260px] flex-col border-r border-[#e5e8ec] bg-[#155239] text-white transition-transform lg:static lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
          <div className="flex h-[78px] items-center justify-between border-b border-[#eef0f2] px-6">
            <div className="flex items-center gap-3">
              <div className="flex size-10 items-center justify-center rounded-xl bg-[#1f6b45] text-white shadow-sm"><Landmark /></div>
          ...
          <nav className="flex-1 px-4 py-6" aria-label="Navigasi utama">
            ...
            <div className="flex flex-col gap-1">
              <a href="#beranda" className="flex items-center gap-3 rounded-xl bg-[#e8f3ed] px-3 py-3 text-[13px] font-bold text-[#1f6b45]"><Grid2X2 /> Beranda</a>
